...
vim.api.nvim_set_hl(0, "GitSignsAddPreview",        { bg = '#002800' })
vim.api.nvim_set_hl(0, "GitSignsDeletePreview",     { bg = '#3f0001' })
vim.api.nvim_set_hl(0, "GitSignsDeleteVirtLn",      { bg = '#3f0001' })
vim.api.nvim_set_hl(0, "GitSignsAddInline",         { bg = '#006000' })
vim.api.nvim_set_hl(0, "GitSignsDeleteInline",      { bg = '#901011' })
vim.api.nvim_set_hl(0, "GitSignsChangeInline",      { bg = '#006000' })
