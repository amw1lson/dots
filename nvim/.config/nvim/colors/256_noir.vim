...
if has("gui_running") || &t_Co == 256
    ...
    hi StatusLine cterm=bold,reverse ctermfg=124 ctermbg=16 gui=bold,reverse guifg=#8a8a8a guibg=#000000
    hi StatusLineNC cterm=reverse ctermfg=240 ctermbg=16 gui=reverse guifg=#303030 guibg=#000000
