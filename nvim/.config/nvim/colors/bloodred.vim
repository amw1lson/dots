...
let s:light_black     = { "gui": "#202020", "cterm": "235" }
...
call s:h("IncSearch",     {"bg": s:light_gray, "fg": s:black})
call s:h("Search",        {"bg": s:light_gray, "fg": s:black})
...
call s:h("DiffAdd",       {"fg": s:light_red})
call s:h("DiffDelete",    {"fg": s:red})
call s:h("DiffChange",    {"fg": s:dark_red})
call s:h("DiffText",      {"fg": s:dark_red})
call s:h("SignColumn",    {"fg": s:red})
...
call s:h("SyntasticWarning",        {"bg": s:pink, "fg": s:black, "gui": "bold", "cterm": "bold"})
